...
# parameters here
batch_size = 12 # independent sequences in parallel
...
class Block(nn.Module):
    ...
    def __init__(self,n_embd,n_head):
        # n_embd: embedding dimension, n_head: number of heads we like
        super().__init__()
    ...
    def forward(self,x):
        x = x + self.sa(self.ln1(x)) # adding to x is residual
